						...
						echo '<div class="mfn-header">';
							echo '<div class="mfn-buttons">';
								...
								echo '<div class="mfn-buttons-more">';
									...
									echo '<a class="mfn-btn-doc" href="http://themes.muffingroup.com/falco/documentation.pdf" target="_blank"><span>Documentation</span></a>';
									echo '<a class="mfn-btn-demo" href="http://themes.muffingroup.com?theme=falco" target="_blank"><span>Demo</span></a>';
								echo '</div>';
							echo '</div>';
